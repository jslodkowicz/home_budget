...
class NonAuthTransactionApiTests(TestCase):
    ...
    def test_retrieve_transaction_list_not_authenticated(self):
        ...
        transaction_1.user.add(self.user)
        transaction_2.user.add(self.user)
...
class AuthTransactionApiTests(TestCase):
    ...
    def test_expense(self):
        """Test if an expense transaction change the wallet balance"""
        payload = {
    ...
    def test_income(self):
        """Test if an income transaction change the wallet balance"""
        payload = {
            'wallet': self.wallet.id,
            'title': 'banany',
            'amount': 12.30,
